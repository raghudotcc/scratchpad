  ...
  function showRelated(dataAction, dataUrl) {
    getRelatedHTML(dataUrl)
     .then(function (responseText) {
      ...
      relatedItemHTMLTitle.style.fontFamily = "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif";
      ...
      for (var i = 0; i < urls.length; i++) {
          ...
          newAnchor.style.fontFamily = "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif";
      ...
      relatedItemHTML.style.marginLeft = "-10px";
